...
define('tui/random', [], function(require, exports) {
	...
	function rand(num, prefix) {
		prefix = typeof prefix == 'undefined' ? '' : prefix;

		var PRNGran = new MRG32k3a(num || 0, location.href, Date.now());

		return prefix + (+new Date()).toString(32) + (parseInt(PRNGran() * 100000)).toString(32);
	}
